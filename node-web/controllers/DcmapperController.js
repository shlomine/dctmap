...
var Contact = require(config.dcmapp.schema+'Contacts');

var DcmapperController = {};

// show list of customers function.
DcmapperController.list = function(req, res) {
...
DcmapperController.show = function(req, res) {
...
DcmapperController.create = function(req, res) {
  res.render("../views/customers/create");
};

// save new customer function.
DcmapperController.save = function(req, res) {
...
DcmapperController.edit = function(req, res) {
  Customer.findOne({_id: req.params.id}).exec(function (err, customer) {
    if (err) {
      console.log("Error:", err);
    }
...
DcmapperController.update = function(req, res) {
...
DcmapperController.delete = function(req, res) {
...
module.exports = DcmapperController;
